...
public class SwingAudioPlayer extends JPanel implements ActionListener {
	...
	private String name;
	private JLabel labelFileName = new JLabel("Song:");
	private JLabel labelTimeCounter = new JLabel("00:00");
	...
	public SwingAudioPlayer() {
		...
		sliderTime.setPreferredSize(new Dimension(150, 20));
		...
		playbackThread = new Thread(new Runnable() {
			...
			public void run() {
				try {
					...
					labelFileName.setText("Playing File: " + name);
